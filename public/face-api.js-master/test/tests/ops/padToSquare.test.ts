...
describe('padToSquare', () => {
  describe('even size', () => {
    it('is padded to square by 2 columns', () =>
      tf.tidy(() => {
    ...
    it('is padded to square by 2 columns and centered', () =>
      tf.tidy(() => {
        const imgTensor = tf.tensor4d(Array(24).fill(1), [1, 4, 2, 3]);
    ...
    it('is padded to square by 1 column', () =>
      tf.tidy(() => {
    ...
    it('is padded to square by 1 column and centered', () =>
      tf.tidy(() => {
        const imgTensor = tf.tensor4d(Array(36).fill(1), [1, 4, 3, 3]);
        const result = padToSquare(imgTensor, true);
  ...
  describe('uneven size', () => {
    it('is padded to square by 3 columns', () =>
      tf.tidy(() => {
    ...
    it('is padded to square by 3 columns and centered', () =>
      tf.tidy(() => {
        const imgTensor = tf.tensor4d(Array(30).fill(1), [1, 5, 2, 3]);
        const result = padToSquare(imgTensor, true);
